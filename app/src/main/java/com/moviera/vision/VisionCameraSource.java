...
public class VisionCameraSource
{
    ...
    public static String FLASH_MODE_RED_EYE = Camera.Parameters.FLASH_MODE_RED_EYE;
    public static String FLASH_MODE_TORCH = Camera.Parameters.FLASH_MODE_TORCH;

    public static String EFFECT_AQUA = Camera.Parameters.EFFECT_AQUA;
    public static String EFFECT_BLACKBOARD = Camera.Parameters.EFFECT_BLACKBOARD;
    public static String EFFECT_MONO = Camera.Parameters.EFFECT_MONO;
    public static String EFFECT_NEGATIVE = Camera.Parameters.EFFECT_NEGATIVE;
    public static String EFFECT_NONE = Camera.Parameters.EFFECT_NONE;
    public static String EFFECT_POSTERIZE = Camera.Parameters.EFFECT_POSTERIZE;
    public static String EFFECT_SEPIA = Camera.Parameters.EFFECT_SEPIA;
    public static String EFFECT_SOLARIZE = Camera.Parameters.EFFECT_SOLARIZE;
    public static String EFFECT_WHITEBOARD = Camera.Parameters.EFFECT_WHITEBOARD;
    ...
    public static class Builder
    {
        ...
        private VisionCameraSource mCameraSource = new VisionCameraSource();
       ...
       /* public Builder setFocusMode(@FocusMode String mode) {
         ...
         */
        public VisionCameraSource build() {
    ...
    public VisionCameraSource start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public VisionCameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
   ...
   /* @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    ...
    private boolean setFocusMode(String focusMode, Camera camera)
    {
        boolean focusSet;
    ...
    private Camera createCamera()
    {
        ...
        boolean focus = setFocusMode(Camera.Parameters.FOCUS_MODE_CONTINUOUS_VIDEO, camera);
    ...
    private static SizePair selectSizePair(Camera camera, int desiredWidth, int desiredHeight)
    {
        ...
        {
            Log.d("CameraSize", "Preview sizes: " + s.height + " : " + s.width);
            if (((float)s.width / (float)s.height) == 16f / 9f)
            {
        ...
        for (Camera.Size s : pictureSizes)
        {
            if (((float)s.width / (float)s.height) == 16f / 9f)
            {
                if (s.width > desiredWidth && s.height > desiredHeight)
                {
                    pictureSize.width = s.width;
                    pictureSize.height = s.height;
                }
            }
        }

        Log.d("CameraSize", "Desired sizes: " + desiredHeight + " : " + desiredWidth);
        Log.d("CameraSize", "Preview sizes: " + previewSize.height + " : " + previewSize.width);
    ...
    {
        private VisionCameraSource visionCamera;

        public CameraPreviewCallback(VisionCameraSource visionCamera) {
            this.visionCamera = visionCamera;
        }

        @Override
        public void onPreviewFrame(byte[] data, Camera camera) {
            // consider using image view
