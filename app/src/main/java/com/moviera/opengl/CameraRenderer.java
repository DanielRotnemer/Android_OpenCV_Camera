...
import com.moviera.opengl.filter.*;
...
public class CameraRenderer implements Runnable, TextureView.SurfaceTextureListener, Camera.PreviewCallback
{
    ...
    @Override
    public void onPreviewFrame(byte[] data, Camera pCamera) {
        Log.d("LoadShader", "Byte copy length: " + data.length);
